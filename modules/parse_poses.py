...
def get_root_relative_poses(inference_results):
    ...
    # print("len(poses_3d)",len(poses_3d))
    # print("len(poses_2d)",len(poses_2d))
    for pose_id in range(len(poses_3d)):
        # print("1st treshold",pose_id,poses_2d[pose_id][2])
        if poses_2d[pose_id][2] > keypoint_treshold:
            ...
            for limb in limbs:
                for kpt_id_from in limb:
                    # print("2nd treshold",pose_id,kpt_id_from,poses_2d[pose_id][kpt_id_from * 3 + 2])
